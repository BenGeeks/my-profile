    ...
    <section className={styles.container}>
      ...
      <div className={styles.testimonial}>
        ...
        <div className={styles.text}>
          ...
          <p>
            ...
            His latest task consisted in turning a cloud-based software into a PWA, which he did susscessfully, even having been his first attempt at it. I shall be hapoy to have him join our team in
      ...
      <div className={styles.testimonial}>
        ...
        <div className={styles.text}>
          ...
          <p>
            We would highly suggest him to anyone who is looking for an all arounder, one who can be very versatile on any fields within the Saas Industry and one who is very hungry to learn more.
          </p>
          <br />
